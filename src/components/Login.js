...
const redirect_uri = "https://spotifyme-6970f.web.app"

const url_spotify = `https://accounts.spotify.com/authorize?client_id=${client_id}&response_type=code&redirect_uri=${redirect_uri}&state=${statee}`
